...
@Component({
  selector: 'app-doktor-pacient-ochorenia-share',
  templateUrl: './doktor-pacient-ochorenia-share.component.html',
  styleUrls: ['./doktor-pacient-ochorenia-share.component.css']
})
export class DoktorPacientOchoreniaShareComponent {
  oddelenia:Oddelenie[] = [];
  ...
  share() {
    ...
    this.shareService.shareOchorenia(zdielajuci,this.osobneCisloSelected,rodnecislo,datumReady).subscribe(
      () => {
