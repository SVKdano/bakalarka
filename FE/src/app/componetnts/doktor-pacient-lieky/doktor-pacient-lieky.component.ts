...
@Component({
  selector: 'app-doktor-pacient-lieky',
  templateUrl: './doktor-pacient-lieky.component.html',
  styleUrls: ['./doktor-pacient-lieky.component.css']
})
export class DoktorPacientLiekyComponent {
