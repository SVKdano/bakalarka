...
@Component({
  selector: 'app-doktor-reset-hesla',
  templateUrl: './doktor-reset-hesla.component.html',
  styleUrls: ['./doktor-reset-hesla.component.css']
})
export class DoktorResetHeslaComponent {
  user: User = new User();
