...
@Component({
  selector: 'app-doktor-pacient-listky',
  templateUrl: './doktor-pacient-listky.component.html',
  styleUrls: ['./doktor-pacient-listky.component.css']
})
export class DoktorPacientListkyComponent {
