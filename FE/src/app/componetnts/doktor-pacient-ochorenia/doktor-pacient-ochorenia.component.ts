...
@Component({
  selector: 'app-doktor-pacient-ochorenia',
  templateUrl: './doktor-pacient-ochorenia.component.html',
  styleUrls: ['./doktor-pacient-ochorenia.component.css']
})
export class DoktorPacientOchoreniaComponent {
